...
class Settings(BaseSettings):
    ...
    analytics_rollup_seconds: int = Field(default=60, alias="ANALYTICS_ROLLUP_SECONDS", ge=10)
    supermemory_api_key: Optional[str] = Field(default=None, alias="SUPERMEMORY_API_KEY")
    supermemory_base_url: str = Field(default="https://api.supermemory.ai", alias="SUPERMEMORY_BASE_URL")
    brevo_api_key: Optional[str] = Field(default=None, alias="BREVO_API_KEY")
    brevo_base_url: str = Field(default="https://api.brevo.com", alias="BREVO_BASE_URL")
    brevo_invite_sender_email: Optional[str] = Field(default=None, alias="BREVO_INVITE_SENDER_EMAIL")
    brevo_invite_sender_name: str = Field(default="Engyne", alias="BREVO_INVITE_SENDER_NAME")
    brevo_updates_sender_email: Optional[str] = Field(default=None, alias="BREVO_UPDATES_SENDER_EMAIL")
    brevo_updates_sender_name: str = Field(default="Engyne Updates", alias="BREVO_UPDATES_SENDER_NAME")
